...
const postService = (() => {
    ...
    const getPostsList = async (keyword, page, callback) => {
        // API에 데이터 요청
        const response = await fetch (`/managers-page/posts/posts-list/?keyword=${keyword}&page=${page}`);
    ...
    const getKnowhowList = async (keyword, page, callback) => {
        // API에 데이터 요청
        const response = await fetch (`/managers-page/posts/knowhow-list/?keyword=${keyword}&page=${page}`);
        const posts = await response.json();
    ...
    const getTradeList = async (keyword, page, callback) => {
        // API에 데이터 요청
        const response = await fetch (`/managers-page/posts/trade-list/?keyword=${keyword}&page=${page}`);
        const posts = await response.json();
    ...
    const deletePosts = async (postIds) => {
        await fetch(`/managers-page/posts/posts-delete/${postIds}`, {
            method: 'delete',
    ...
    const deleteKnowhows = async (knowhowIds) => {
        await fetch(`/managers-pagen/posts/knowhow-delete/${knowhowIds}`, {
            method: 'delete',
            headers: {'X-CSRFToken': csrf_token}
        });
    }
    ...
    const deleteTrades = async (tradeIds) => {
        await fetch(`/managers-page/posts/trade-delete/${tradeIds}`, {
            method: 'PATCH',
            headers: {'X-CSRFToken': csrf_token}
        });
    }
    ...
    const countPosts = async () => {
        const response = await fetch(`/managers-page/posts/posts-count/`);
    ...
    const countKnowhows = async () => {
        const response = await fetch(`/managers-page/posts/knowhow-count/`);
    ...
    const countTrades = async () => {
        const response = await fetch(`/managers-page/posts/trade-count/`);
